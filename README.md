...
Just 3 push-buttons ans a attiny85 based MCU. Dont forget the square button is plugged between "VCC" and D1, and the arrow buttons are plugged between GND an D0 and D2 ,a way to use the D1 led on this kind of MCUs with absolutelly no external componnents.
